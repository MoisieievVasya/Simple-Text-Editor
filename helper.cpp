...
void helper() {
	printf("To use text editor type command: \n");
	printf("1 - Append text \n");
	printf("2 - Start new line \n");
	printf("3 - Use file to load the information \n");
	printf("4 - Use file to save the information \n");
	...
	printf("9 - Something interesting \n");
